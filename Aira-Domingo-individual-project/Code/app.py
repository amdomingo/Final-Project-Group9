...
def fit(value):
    ...
    return {
        'data': [
            go.Scatter(
                x=scaled_x_test.squeeze(),
                y=scaled_y_test.squeeze(),
                name='Test Data',
                mode='markers',
                opacity=0.7
            ),
        ...
        'layout': go.Layout (
            ...
            xaxis={'title': 'Land Use (GHA)'},
            yaxis={'title': 'Carbon Emissions (GHA)'},
            title=f"R-Sqaured: {test_r2:.3f}, MSE: {test_error:.3f} (Test Data)",
            hovermode='closest'
        ),
